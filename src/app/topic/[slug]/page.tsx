...
export default function TopicPage({ params }: TopicPageProps): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#040814] text-slate-100 selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-10 flex-1 w-full">
        ...
        {/* WebMD-Style Sub-Topics Directory (The core subtopics of this topic) */}
        ...
        {/* WebMD-Style Interactive Diagnostic / Calculator Specific to this Discipline */}
